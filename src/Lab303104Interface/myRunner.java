...
public class myRunner {
    public static void main(String[] args) {
        ...
        c1.moveUp();
        System.out.println("After move up, cooridinates are: " + c1.getCoordinate());

        c1.moveLeft();
        System.out.println("After move left, coordinates are " + c1.getCoordinate());

        System.out.println("-------- Test Polymoprphism --------");
        ...
        Movable c3 = new Triangle(5);
        System.out.println(c3.getCoordinate());
